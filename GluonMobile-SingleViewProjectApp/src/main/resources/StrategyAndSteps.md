...
- 单调性判别法  根据结论1,减法$a_{n+1}-a_n, 除法\frac{a_{n+1}}{a_n}$
...
1. 无穷大的分式多项式, 分子分母除以最高次项,低次为0
2. 带根号的,分子分母有理化.
3. 提取公因式, 加法变乘法
4. $1^\infty$类型的极限,使用$\lim (1+x)^{\frac1x}=e$

5. 定积分求$n$项和极限

6. 使用夹逼定理, 要找到表达式主部, 即其主要作用的部分.
